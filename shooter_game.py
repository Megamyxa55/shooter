...
for i in range(1,6):
    asteroid = Enemyy(img_asteroid,randint(30,win_width - 30),-40,80,50,randint(1,7))
...
while run:
    ...
    if not finish:
        ...
        if rel_time == True:
            ...
            if now_time - last_time < 1 and now_time - last_time > 0 :
                reload = font2.render("wait,reload.",1,(150,0,0))
                window.blit(reload,(260,460))
                
            elif now_time - last_time < 2 and now_time - last_time > 1 :
                reload = font2.render("wait,reload..",1,(150,0,0))
                window.blit(reload,(260,460))
            
            elif now_time - last_time < 3 and now_time - last_time > 2 :
                reload = font2.render("wait,reload...",1,(150,0,0))
                window.blit(reload,(260,460))
            else:
                num_fire = 0
